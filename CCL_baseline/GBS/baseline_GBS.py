...
def con_learn():
    file_name = 'GBS-198-1.csv'
    f = open(file_name, 'w', encoding='utf-8', newline='')
    csv_writer = csv.writer(f)
    csv_writer.writerow(["datasets", "f1-ori", "f1-gbs", "auc-ori", "auc-gbs", "pre-ori", "pre-gbs", "recall-ori", "recall-gbs",
                         "mcc-ori", "mcc-gbs", "effort-ori", "effort-gbs"])
    for i in range(10):
        ...
        for ix in range(10):
            ...
            for train_index, test_index in sfolder.split(ob, label):
                ...
                x_pruned, s_pruned = GBS.main(X_train, y_train)
