    ...
    for i in range(10):
        ...
        for ix in range(10):
            ...
            for train_index, test_index in sfolder.split(ob, label):
                ...
                print('%s Epoch [%d/%d] Test Accuracy on the %s test: Model1 %.4f,the mcc on the test: %.4f, f1 : %.4f' % (
                   csv_string, epoch + 1, args.n_epoch, len(Y_test), test_acc1, test_mcc1, test_f11))
